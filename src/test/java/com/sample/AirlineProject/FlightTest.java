...
class FlightTest 
{
	...
	void testFindAll() 
	{
		...
		fleet2.setTotalBusinessSeats(143);
		fleet2.setTotalEconomySeats(360);
		fleet2.setTotalPremiumSeats(130);
		FlightStatus flightStatus2 = new FlightStatus();
		flightStatus2.setRemainingBusinessSeats(12);
		flightStatus2.setRemainingEconomySeats(11);
		flightStatus2.setRemainingPremiumSeats(10);
